...
//       await axios.put("/api/modules/updateModule", {
//         _id: editingModule._id,
//         name: editingModule.name,
//         description: editingModule.description,
//         newVideo: editingModule.newVideo ? videoUrl : null, // Ensures old video is removed
//       });

//       setModules((prevModules) =>
//         prevModules.map((mod) =>
//           mod._id === editingModule._id ? { ...mod, name: editingModule.name, description: editingModule.description, videoUrl } : mod
//         )
//       );
...
//       alert("An error occurred while updating the module. Please try again.");
//     }
